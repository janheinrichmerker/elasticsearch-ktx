...
suspend inline fun MachineLearningClient.deleteDatafeedAsync(
    datafeedId: String,
    options: RequestOptions = RequestOptions.DEFAULT,
    block: DeleteDatafeedRequest.() -> Unit = {}
...
suspend inline fun MachineLearningClient.startDatafeedAsync(
    datafeedId: String,
    options: RequestOptions = RequestOptions.DEFAULT,
    block: StartDatafeedRequest.() -> Unit = {}
...
suspend inline fun MachineLearningClient.previewDatafeedAsync(
    datafeedId: String,
    options: RequestOptions = RequestOptions.DEFAULT,
    block: PreviewDatafeedRequest.() -> Unit = {}
...
suspend inline fun MachineLearningClient.postDataAsync(
    jobId: String,
    xContentType: XContentType,
    content: BytesReference,
    options: RequestOptions = RequestOptions.DEFAULT,
    block: PostDataRequest.() -> Unit = {}
): PostDataResponse =
    awaitAction {
        postDataAsync(
            jobId,
...
suspend inline fun MachineLearningClient.postDataAsync(
    jobId: String,
    builder: PostDataRequest.JsonBuilder,
    options: RequestOptions = RequestOptions.DEFAULT,
    block: PostDataRequest.() -> Unit = {}
): PostDataResponse =
    awaitAction {
...
suspend inline fun MachineLearningClient.deleteCalendarAsync(
    calendarId: String,
    options: RequestOptions = RequestOptions.DEFAULT,
    block: DeleteCalendarRequest.() -> Unit = {}
): AcknowledgedResponse =
    awaitAction {
        deleteCalendarAsync(
            calendarId,
