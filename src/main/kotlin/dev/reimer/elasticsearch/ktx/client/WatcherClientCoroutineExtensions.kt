...
suspend inline fun WatcherClient.ackWatchAsync(
        watchId: String,
        vararg actionIds: String,
        options: RequestOptions = RequestOptions.DEFAULT,
        block: AckWatchRequest.() -> Unit = {}
): AckWatchResponse =
        awaitAction {
                ackWatchAsync(
                        watchId = watchId,
...
suspend inline fun WatcherClient.activateWatchAsync(
        watchId: String,
        options: RequestOptions = RequestOptions.DEFAULT,
        block: ActivateWatchRequest.() -> Unit = {}
