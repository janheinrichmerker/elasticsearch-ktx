...
suspend inline fun SecurityClient.putRoleMappingAsync(
    ...
    enabled: Boolean,
    roles: List<String>,
    rules: RoleMapperExpression,
    metadata: Map<String, Any> = emptyMap(),
    refreshPolicy: RefreshPolicy = RefreshPolicy.getDefault(),
    options: RequestOptions = RequestOptions.DEFAULT,
    block: PutRoleMappingRequest.() -> Unit = {}
...
suspend inline fun SecurityClient.deleteRoleMappingAsync(
    name: String,
    refreshPolicy: RefreshPolicy = RefreshPolicy.getDefault(),
    options: RequestOptions = RequestOptions.DEFAULT,
    block: DeleteRoleMappingRequest.() -> Unit = {}
...
suspend inline fun SecurityClient.deleteRoleAsync(
    name: String,
    refreshPolicy: RefreshPolicy = RefreshPolicy.IMMEDIATE,
    options: RequestOptions = RequestOptions.DEFAULT,
    block: DeleteRoleRequest.() -> Unit = {}
): DeleteRoleResponse =
    awaitAction {
        deleteRoleAsync(
            name,
