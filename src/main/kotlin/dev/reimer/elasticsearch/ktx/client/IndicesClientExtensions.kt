...
inline fun IndicesClient.createAsync(options: RequestOptions = RequestOptions.DEFAULT, listener: ActionListener<CreateIndexResponse>, block: CreateIndexRequest.() -> Unit = {}): Cancellable =
